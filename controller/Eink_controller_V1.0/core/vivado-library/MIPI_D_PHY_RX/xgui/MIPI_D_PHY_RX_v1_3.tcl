...
proc init_gui { IPINST } {
  ...
  set kSharedLogic [ipgui::add_param $IPINST -name "kSharedLogic" -parent ${Control}]
  set_property tooltip {Choose Yes for one master instance, No for slave instances} ${kSharedLogic}
...
proc update_PARAM_VALUE.kSharedLogic { PARAM_VALUE.kSharedLogic } {
	# Procedure called to update kSharedLogic when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.kSharedLogic { PARAM_VALUE.kSharedLogic } {
	# Procedure called to validate kSharedLogic
	return true
}
...
proc update_MODELPARAM_VALUE.kSharedLogic { MODELPARAM_VALUE.kSharedLogic PARAM_VALUE.kSharedLogic } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.kSharedLogic}] ${MODELPARAM_VALUE.kSharedLogic}
}
