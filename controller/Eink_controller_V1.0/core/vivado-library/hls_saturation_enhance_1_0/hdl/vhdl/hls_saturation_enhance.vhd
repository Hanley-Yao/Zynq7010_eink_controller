...
entity hls_saturation_enhance is
generic (
...
architecture behav of hls_saturation_enhance is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "hls_saturation_enhance,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=6.670000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=6.380000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=7,HLS_SYN_DSP=8,HLS_SYN_FF=7965,HLS_SYN_LUT=7349}";
    ...
    signal Block_Mat_exit1573_p_U0_sat_out_din : STD_LOGIC_VECTOR (7 downto 0);
    signal Block_Mat_exit1573_p_U0_sat_out_write : STD_LOGIC;
    ...
    signal Loop_loop_height_pro_U0_sat_read : STD_LOGIC;
    ...
    component start_for_Loop_lotde IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component hls_saturation_enhance_AXILiteS_s_axi IS
    generic (
...
begin
    hls_saturation_enhance_AXILiteS_s_axi_U : component hls_saturation_enhance_AXILiteS_s_axi
    generic map (
    ...
    sat_c_U : component fifo_w8_d3_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Loop_lotde_U : component start_for_Loop_lotde
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    Block_Mat_exit1573_p_U0_start_full_n <= (start_for_Mat2AXIvideo_U0_full_n and start_for_Loop_loop_height_pro_U0_full_n and start_for_CvtColor_1_U0_full_n);
