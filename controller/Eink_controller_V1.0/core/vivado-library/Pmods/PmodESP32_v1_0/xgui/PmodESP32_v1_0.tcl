...
proc update_PARAM_VALUE.C_AXI_LITE_UART_DATA_WIDTH { PARAM_VALUE.C_AXI_LITE_UART_DATA_WIDTH } {
	# Procedure called to update C_AXI_LITE_UART_DATA_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_AXI_LITE_UART_DATA_WIDTH { PARAM_VALUE.C_AXI_LITE_UART_DATA_WIDTH } {
	# Procedure called to validate C_AXI_LITE_UART_DATA_WIDTH
	return true
}

proc update_PARAM_VALUE.C_AXI_LITE_UART_ADDR_WIDTH { PARAM_VALUE.C_AXI_LITE_UART_ADDR_WIDTH } {
	# Procedure called to update C_AXI_LITE_UART_ADDR_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_AXI_LITE_UART_ADDR_WIDTH { PARAM_VALUE.C_AXI_LITE_UART_ADDR_WIDTH } {
	# Procedure called to validate C_AXI_LITE_UART_ADDR_WIDTH
	return true
}

proc update_PARAM_VALUE.C_AXI_LITE_UART_BASEADDR { PARAM_VALUE.C_AXI_LITE_UART_BASEADDR } {
	# Procedure called to update C_AXI_LITE_UART_BASEADDR when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_AXI_LITE_UART_BASEADDR { PARAM_VALUE.C_AXI_LITE_UART_BASEADDR } {
	# Procedure called to validate C_AXI_LITE_UART_BASEADDR
	return true
}

proc update_PARAM_VALUE.C_AXI_LITE_UART_HIGHADDR { PARAM_VALUE.C_AXI_LITE_UART_HIGHADDR } {
	# Procedure called to update C_AXI_LITE_UART_HIGHADDR when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_AXI_LITE_UART_HIGHADDR { PARAM_VALUE.C_AXI_LITE_UART_HIGHADDR } {
	# Procedure called to validate C_AXI_LITE_UART_HIGHADDR
	return true
}
...
proc update_MODELPARAM_VALUE.C_AXI_LITE_UART_DATA_WIDTH { MODELPARAM_VALUE.C_AXI_LITE_UART_DATA_WIDTH PARAM_VALUE.C_AXI_LITE_UART_DATA_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_AXI_LITE_UART_DATA_WIDTH}] ${MODELPARAM_VALUE.C_AXI_LITE_UART_DATA_WIDTH}
}

proc update_MODELPARAM_VALUE.C_AXI_LITE_UART_ADDR_WIDTH { MODELPARAM_VALUE.C_AXI_LITE_UART_ADDR_WIDTH PARAM_VALUE.C_AXI_LITE_UART_ADDR_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_AXI_LITE_UART_ADDR_WIDTH}] ${MODELPARAM_VALUE.C_AXI_LITE_UART_ADDR_WIDTH}
}
