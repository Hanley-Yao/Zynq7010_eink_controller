...
//Command     : generate_target PmodALS.bd
//Design      : PmodALS
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "PmodALS,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=PmodALS,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=2,numReposBlks=2,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,synth_mode=Global}" *) (* HW_HANDOFF = "PmodALS.hwdef" *) 
module PmodALS
   (AXI_LITE_SPI_araddr,
  ...
  PmodALS_axi_quad_spi_0_0 axi_quad_spi_0
  ...
  PmodALS_pmod_bridge_0_0 pmod_bridge_0
