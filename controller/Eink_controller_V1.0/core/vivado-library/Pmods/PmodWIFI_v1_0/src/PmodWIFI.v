...
//Date        : Mon Jul 18 13:55:22 2016
//Host        : WK116 running 64-bit major release  (build 9200)
//Command     : generate_target PmodWIFI.bd
//Design      : PmodWIFI
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "PmodWIFI,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=PmodWIFI,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=5,numReposBlks=5,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=Global}" *) (* HW_HANDOFF = "PmodWIFI.hwdef" *) 
module PmodWIFI
  ...
  wire S_AXI_2_WVALID;
  wire [0:0]axi_gpio_cs_gpio_io_o;
  wire [0:0]axi_gpio_cs_gpio_io_t;
  wire [3:0]axi_gpio_wf_GPIO_TRI_I;
  wire [3:0]axi_gpio_wf_GPIO_TRI_O;
  wire [3:0]axi_gpio_wf_GPIO_TRI_T;
  wire axi_gpio_wf_ip2intc_irpt;
  ...
  assign AXI_LITE_GPIO_WFCS_arready = S_AXI_1_ARREADY;
  assign AXI_LITE_GPIO_WFCS_awready = S_AXI_1_AWREADY;
  assign AXI_LITE_GPIO_WFCS_bresp[1:0] = S_AXI_1_BRESP;
  assign AXI_LITE_GPIO_WFCS_bvalid = S_AXI_1_BVALID;
  assign AXI_LITE_GPIO_WFCS_rdata[31:0] = S_AXI_1_RDATA;
  assign AXI_LITE_GPIO_WFCS_rresp[1:0] = S_AXI_1_RRESP;
  assign AXI_LITE_GPIO_WFCS_rvalid = S_AXI_1_RVALID;
  assign AXI_LITE_GPIO_WFCS_wready = S_AXI_1_WREADY;
  ...
  assign AXI_LITE_WFGPIO_arready = S_AXI_1_1_ARREADY;
  assign AXI_LITE_WFGPIO_awready = S_AXI_1_1_AWREADY;
  assign AXI_LITE_WFGPIO_bresp[1:0] = S_AXI_1_1_BRESP;
  assign AXI_LITE_WFGPIO_bvalid = S_AXI_1_1_BVALID;
  assign AXI_LITE_WFGPIO_rdata[31:0] = S_AXI_1_1_RDATA;
  assign AXI_LITE_WFGPIO_rresp[1:0] = S_AXI_1_1_RRESP;
  assign AXI_LITE_WFGPIO_rvalid = S_AXI_1_1_RVALID;
  assign AXI_LITE_WFGPIO_wready = S_AXI_1_1_WREADY;
  ...
  assign S_AXI_1_1_ARADDR = AXI_LITE_WFGPIO_araddr[8:0];
  assign S_AXI_1_1_ARVALID = AXI_LITE_WFGPIO_arvalid;
  assign S_AXI_1_1_AWADDR = AXI_LITE_WFGPIO_awaddr[8:0];
  assign S_AXI_1_1_AWVALID = AXI_LITE_WFGPIO_awvalid;
  assign S_AXI_1_1_BREADY = AXI_LITE_WFGPIO_bready;
  assign S_AXI_1_1_RREADY = AXI_LITE_WFGPIO_rready;
  assign S_AXI_1_1_WDATA = AXI_LITE_WFGPIO_wdata[31:0];
  assign S_AXI_1_1_WSTRB = AXI_LITE_WFGPIO_wstrb[3:0];
  assign S_AXI_1_1_WVALID = AXI_LITE_WFGPIO_wvalid;
  assign S_AXI_1_ARADDR = AXI_LITE_GPIO_WFCS_araddr[8:0];
  assign S_AXI_1_ARVALID = AXI_LITE_GPIO_WFCS_arvalid;
  assign S_AXI_1_AWADDR = AXI_LITE_GPIO_WFCS_awaddr[8:0];
  assign S_AXI_1_AWVALID = AXI_LITE_GPIO_WFCS_awvalid;
  assign S_AXI_1_BREADY = AXI_LITE_GPIO_WFCS_bready;
  assign S_AXI_1_RREADY = AXI_LITE_GPIO_WFCS_rready;
  assign S_AXI_1_WDATA = AXI_LITE_GPIO_WFCS_wdata[31:0];
  assign S_AXI_1_WSTRB = AXI_LITE_GPIO_WFCS_wstrb[3:0];
  assign S_AXI_1_WVALID = AXI_LITE_GPIO_WFCS_wvalid;
  assign S_AXI_2_ARADDR = S_AXI_TIMER_araddr[4:0];
  assign S_AXI_2_ARVALID = S_AXI_TIMER_arvalid;
  assign S_AXI_2_AWADDR = S_AXI_TIMER_awaddr[4:0];
  assign S_AXI_2_AWVALID = S_AXI_TIMER_awvalid;
  assign S_AXI_2_BREADY = S_AXI_TIMER_bready;
  assign S_AXI_2_RREADY = S_AXI_TIMER_rready;
  assign S_AXI_2_WDATA = S_AXI_TIMER_wdata[31:0];
  assign S_AXI_2_WSTRB = S_AXI_TIMER_wstrb[3:0];
  assign S_AXI_2_WVALID = S_AXI_TIMER_wvalid;
  assign S_AXI_TIMER_arready = S_AXI_2_ARREADY;
  assign S_AXI_TIMER_awready = S_AXI_2_AWREADY;
  assign S_AXI_TIMER_bresp[1:0] = S_AXI_2_BRESP;
  assign S_AXI_TIMER_bvalid = S_AXI_2_BVALID;
  assign S_AXI_TIMER_rdata[31:0] = S_AXI_2_RDATA;
  assign S_AXI_TIMER_rresp[1:0] = S_AXI_2_RRESP;
  assign S_AXI_TIMER_rvalid = S_AXI_2_RVALID;
  assign S_AXI_TIMER_wready = S_AXI_2_WREADY;
  assign WF_INTERRUPT = axi_gpio_wf_ip2intc_irpt;
  ...
  PmodWIFI_axi_gpio_0_0 axi_gpio_cs
       (.gpio_io_i(pmod_bridge_0_in0_I),
        .gpio_io_o(axi_gpio_cs_gpio_io_o),
        .gpio_io_t(axi_gpio_cs_gpio_io_t),
  ...
  PmodWIFI_axi_gpio_1_0 axi_gpio_wf
       (.gpio_io_i(axi_gpio_wf_GPIO_TRI_I),
        .gpio_io_o(axi_gpio_wf_GPIO_TRI_O),
        .gpio_io_t(axi_gpio_wf_GPIO_TRI_T),
        .ip2intc_irpt(axi_gpio_wf_ip2intc_irpt),
        .s_axi_aclk(s_axi_aclk_1),
  ...
  PmodWIFI_axi_quad_spi_0_0 axi_quad_spi_0
       (.ext_spi_clk(ext_spi_clk_1),
        ...
        .ss_i(1'b0));
  PmodWIFI_axi_timer_0_0 axi_timer_0
       (.capturetrig0(1'b0),
        .capturetrig1(1'b0),
        .freeze(1'b0),
        .s_axi_aclk(s_axi_aclk_1),
  ...
  PmodWIFI_pmod_bridge_0_0 pmod_bridge_0
       (.in0_I(pmod_bridge_0_in0_I),
        .in0_O(axi_gpio_cs_gpio_io_o),
        .in0_T(axi_gpio_cs_gpio_io_t),
        ...
        .in_bottom_bus_I(axi_gpio_wf_GPIO_TRI_I),
        .in_bottom_bus_O(axi_gpio_wf_GPIO_TRI_O),
        .in_bottom_bus_T(axi_gpio_wf_GPIO_TRI_T),
