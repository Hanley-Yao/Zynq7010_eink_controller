...
//Command     : generate_target PmodACL.bd
//Design      : PmodACL
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "PmodACL,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=PmodACL,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=3,numReposBlks=3,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,synth_mode=Global}" *) (* HW_HANDOFF = "PmodACL.hwdef" *) 
module PmodACL
  ...
  PmodACL_axi_gpio_0_0 axi_gpio_0
  ...
  PmodACL_axi_quad_spi_0_0 axi_quad_spi_0
  ...
  PmodACL_pmod_bridge_0_0 pmod_bridge_0
