...
//  | 10   | 12   | 14   | 16   |
//
//  描述分辨率为 750x200 等效为 375x400
//  EPD控制器 部分直接采用 375x400 规格进行输出即可
//
//  图像输入部分采用 CTM_F 模块重新排列数据
//
//////////////////////////////////////////////////////////////////////////////////


module eink_controller_et073tc1_img_demo#
    (
    ...
    parameter EPD_FREQ                = 6,           // EPD像素时钟频率Mhz
    parameter EPD_H                   = 375,         // EPD屏幕长度
    parameter EPD_V                   = 400,         // EPD屏幕宽度
    parameter PERIOD_CNT              = 16,           // EPD图像刷新周期数
...
//--------------------------------------------------------------
    ...
    assign sys_rst_n = sys_locked & img_locked & rst_n;
