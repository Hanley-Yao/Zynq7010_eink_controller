...
module config_reg_et047tc1 #(
    ...
    //edid par  960x540 60Hz
        ...
        60  : REG_DATA  =   {8'd3, 8'h6c, 8'd10, 8'h47, 8'h00};
        ...
        71  : REG_DATA  =   {8'd3, 8'h6c, 8'd21, 8'h68, 8'h00};
        72  : REG_DATA  =   {8'd3, 8'h6c, 8'd22, 8'h3a, 8'h00};
        ...
        104 : REG_DATA  =   {8'd3, 8'h6c, 8'd54, 8'h8d, 8'h00};
        105 : REG_DATA  =   {8'd3, 8'h6c, 8'd55, 8'h0e, 8'h00};
        106 : REG_DATA  =   {8'd3, 8'h6c, 8'd56, 8'hc0, 8'h00};
        107 : REG_DATA  =   {8'd3, 8'h6c, 8'd57, 8'ha0, 8'h00};
        108 : REG_DATA  =   {8'd3, 8'h6c, 8'd58, 8'h30, 8'h00};
        109 : REG_DATA  =   {8'd3, 8'h6c, 8'd59, 8'h1c, 8'h00};
        110 : REG_DATA  =   {8'd3, 8'h6c, 8'd60, 8'h10, 8'h00};
        ...
        114 : REG_DATA  =   {8'd3, 8'h6c, 8'd64, 8'h35, 8'h00};
        115 : REG_DATA  =   {8'd3, 8'h6c, 8'd65, 8'h00, 8'h00};
        116 : REG_DATA  =   {8'd3, 8'h6c, 8'd66, 8'h20, 8'h00};
        117 : REG_DATA  =   {8'd3, 8'h6c, 8'd67, 8'ha2, 8'h00};
        ...
        128 : REG_DATA  =   {8'd3, 8'h6c, 8'd78, 8'h54, 8'h00};
        129 : REG_DATA  =   {8'd3, 8'h6c, 8'd79, 8'h30, 8'h00};
        130 : REG_DATA  =   {8'd3, 8'h6c, 8'd80, 8'h34, 8'h00};
        131 : REG_DATA  =   {8'd3, 8'h6c, 8'd81, 8'h37, 8'h00};
        ...
        177 : REG_DATA  =   {8'd3, 8'h6c, 8'd127,8'h46, 8'h00};
        // EDID END
