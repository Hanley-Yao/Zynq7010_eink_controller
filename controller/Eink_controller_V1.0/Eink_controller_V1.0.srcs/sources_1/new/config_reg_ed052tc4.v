...
module config_reg_ed052tc4 #(
    ...
    //edid par  1280x720 60Hz
        ...
        60  : REG_DATA  =   {8'd3, 8'h6c, 8'd10, 8'h52, 8'h00};
        61  : REG_DATA  =   {8'd3, 8'h6c, 8'd11, 8'h00, 8'h00};
        62  : REG_DATA  =   {8'd3, 8'h6c, 8'd12, 8'h04, 8'h00};
        ...
        71  : REG_DATA  =   {8'd3, 8'h6c, 8'd21, 8'h73, 8'h00};
        72  : REG_DATA  =   {8'd3, 8'h6c, 8'd22, 8'h41, 8'h00};
        ...
        104 : REG_DATA  =   {8'd3, 8'h6c, 8'd54, 8'hf9, 8'h00};
        105 : REG_DATA  =   {8'd3, 8'h6c, 8'd55, 8'h1b, 8'h00};
        106 : REG_DATA  =   {8'd3, 8'h6c, 8'd56, 8'h00, 8'h00};
        107 : REG_DATA  =   {8'd3, 8'h6c, 8'd57, 8'h18, 8'h00};
        108 : REG_DATA  =   {8'd3, 8'h6c, 8'd58, 8'h51, 8'h00};
        109 : REG_DATA  =   {8'd3, 8'h6c, 8'd59, 8'hd0, 8'h00};
        110 : REG_DATA  =   {8'd3, 8'h6c, 8'd60, 8'h2d, 8'h00};
        111 : REG_DATA  =   {8'd3, 8'h6c, 8'd61, 8'h20, 8'h00};
        ...
        116 : REG_DATA  =   {8'd3, 8'h6c, 8'd66, 8'h40, 8'h00};
        117 : REG_DATA  =   {8'd3, 8'h6c, 8'd67, 8'hb4, 8'h00};
        118 : REG_DATA  =   {8'd3, 8'h6c, 8'd68, 8'h10, 8'h00};
        ...
        128 : REG_DATA  =   {8'd3, 8'h6c, 8'd78, 8'h44, 8'h00};
        129 : REG_DATA  =   {8'd3, 8'h6c, 8'd79, 8'h30, 8'h00};
        130 : REG_DATA  =   {8'd3, 8'h6c, 8'd80, 8'h35, 8'h00};
        131 : REG_DATA  =   {8'd3, 8'h6c, 8'd81, 8'h32, 8'h00};
        132 : REG_DATA  =   {8'd3, 8'h6c, 8'd82, 8'h54, 8'h00};
        133 : REG_DATA  =   {8'd3, 8'h6c, 8'd83, 8'h43, 8'h00};
        134 : REG_DATA  =   {8'd3, 8'h6c, 8'd84, 8'h34, 8'h00};
        ...
        177 : REG_DATA  =   {8'd3, 8'h6c, 8'd127,8'h9e, 8'h00};
        // EDID END
