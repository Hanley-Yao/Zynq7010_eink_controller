...
module config_reg_et017qc4 #(
    ...
    //write Data Index       len    addr  data_0 data_1 data_2
        ...
        71  : REG_DATA  =   {8'd3, 8'h6c, 8'd21, 8'h23, 8'h00};
        72  : REG_DATA  =   {8'd3, 8'h6c, 8'd22, 8'h1b, 8'h00};
        ...
        106 : REG_DATA  =   {8'd3, 8'h6c, 8'd56, 8'h40, 8'h00};
        107 : REG_DATA  =   {8'd3, 8'h6c, 8'd57, 8'h18, 8'h00};
        108 : REG_DATA  =   {8'd3, 8'h6c, 8'd58, 8'h11, 8'h00};
        109 : REG_DATA  =   {8'd3, 8'h6c, 8'd59, 8'hf0, 8'h00};
        ...
        116 : REG_DATA  =   {8'd3, 8'h6c, 8'd66, 8'h50, 8'h00};
        117 : REG_DATA  =   {8'd3, 8'h6c, 8'd67, 8'h3c, 8'h00};
        ...
        177 : REG_DATA  =   {8'd3, 8'h6c, 8'd127,8'h62, 8'h00};
        // EDID END
