...
module eink_controller_et068sc1_img_demo#
    (
    parameter SYS_CLK_FREQ            = 50,           // 系统时钟Mhz
    parameter SCL_FREQ                = 200,          // I2C时钟频率Khz
    parameter DELAY_CNT               = 32'h00FFFFFF, // 系统配置延迟
    // 显示管理
    parameter VCOM                    = 2930,         // -1.81V
    parameter EPD_WID                 = 8,            // EPD数据宽度
    parameter EPD_FREQ                = 13,           // EPD像素时钟频率Mhz
    parameter EPD_H                   = 800,          // EPD屏幕长度
    parameter EPD_V                   = 600,          // EPD屏幕宽度
