...
module config_reg_ed097tc2 #(
    ...
    //write Data Index       len    addr  data_0 data_1 data_2
        ...
        58  : REG_DATA  =   {8'd3, 8'h6c, 8'd8 , 8'h20, 8'h00};
        59  : REG_DATA  =   {8'd3, 8'h6c, 8'd9 , 8'ha3, 8'h00};
        60  : REG_DATA  =   {8'd3, 8'h6c, 8'd10, 8'h00, 8'h00};
        61  : REG_DATA  =   {8'd3, 8'h6c, 8'd11, 8'h0a, 8'h00};
        62  : REG_DATA  =   {8'd3, 8'h6c, 8'd12, 8'h24, 8'h00};
        ...
        71  : REG_DATA  =   {8'd3, 8'h6c, 8'd21, 8'hcb, 8'h00};
        72  : REG_DATA  =   {8'd3, 8'h6c, 8'd22, 8'h8c, 8'h00};
        ...
        104 : REG_DATA  =   {8'd3, 8'h6c, 8'd54, 8'h2e, 8'h00};
        105 : REG_DATA  =   {8'd3, 8'h6c, 8'd55, 8'h1e, 8'h00};
        106 : REG_DATA  =   {8'd3, 8'h6c, 8'd56, 8'hb0, 8'h00};
        107 : REG_DATA  =   {8'd3, 8'h6c, 8'd57, 8'h18, 8'h00};
        108 : REG_DATA  =   {8'd3, 8'h6c, 8'd58, 8'h41, 8'h00};
        109 : REG_DATA  =   {8'd3, 8'h6c, 8'd59, 8'h39, 8'h00};
        110 : REG_DATA  =   {8'd3, 8'h6c, 8'd60, 8'h2d, 8'h00};
        111 : REG_DATA  =   {8'd3, 8'h6c, 8'd61, 8'h30, 8'h00};
        ...
        116 : REG_DATA  =   {8'd3, 8'h6c, 8'd66, 8'h2c, 8'h00};
        117 : REG_DATA  =   {8'd3, 8'h6c, 8'd67, 8'hce, 8'h00};
        ...
        127 : REG_DATA  =   {8'd3, 8'h6c, 8'd77, 8'h48, 8'h00};
        128 : REG_DATA  =   {8'd3, 8'h6c, 8'd78, 8'h44, 8'h00};
        129 : REG_DATA  =   {8'd3, 8'h6c, 8'd79, 8'h4d, 8'h00};
        130 : REG_DATA  =   {8'd3, 8'h6c, 8'd80, 8'h49, 8'h00};
        131 : REG_DATA  =   {8'd3, 8'h6c, 8'd81, 8'h20, 8'h00};
        132 : REG_DATA  =   {8'd3, 8'h6c, 8'd82, 8'h0a, 8'h00};
        133 : REG_DATA  =   {8'd3, 8'h6c, 8'd83, 8'h20, 8'h00};
        134 : REG_DATA  =   {8'd3, 8'h6c, 8'd84, 8'h20, 8'h00};
        ...
        177 : REG_DATA  =   {8'd3, 8'h6c, 8'd127,8'h6c, 8'h00};
        // EDID END
