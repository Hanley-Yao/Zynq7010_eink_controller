...
module config_reg_es108fc1 #(
    ...
    //edid par  1920x1080 60Hz
        ...
        58  : REG_DATA  =   {8'd3, 8'h6c, 8'd8 , 8'h16, 8'h00};
        59  : REG_DATA  =   {8'd3, 8'h6c, 8'd9 , 8'h04, 8'h00};
        60  : REG_DATA  =   {8'd3, 8'h6c, 8'd10, 8'h08, 8'h00};
        61  : REG_DATA  =   {8'd3, 8'h6c, 8'd11, 8'h01, 8'h00};
        62  : REG_DATA  =   {8'd3, 8'h6c, 8'd12, 8'h01, 8'h00};
        63  : REG_DATA  =   {8'd3, 8'h6c, 8'd13, 8'h00, 8'h00};
        64  : REG_DATA  =   {8'd3, 8'h6c, 8'd14, 8'h00, 8'h00};
        65  : REG_DATA  =   {8'd3, 8'h6c, 8'd15, 8'h00, 8'h00};
        66  : REG_DATA  =   {8'd3, 8'h6c, 8'd16, 8'h23, 8'h00};
        67  : REG_DATA  =   {8'd3, 8'h6c, 8'd17, 8'h12, 8'h00};
        68  : REG_DATA  =   {8'd3, 8'h6c, 8'd18, 8'h01, 8'h00};
        69  : REG_DATA  =   {8'd3, 8'h6c, 8'd19, 8'h03, 8'h00};
        70  : REG_DATA  =   {8'd3, 8'h6c, 8'd20, 8'h80, 8'h00};
        71  : REG_DATA  =   {8'd3, 8'h6c, 8'd21, 8'hf0, 8'h00};
        72  : REG_DATA  =   {8'd3, 8'h6c, 8'd22, 8'h87, 8'h00};
        73  : REG_DATA  =   {8'd3, 8'h6c, 8'd23, 8'h78, 8'h00};
        74  : REG_DATA  =   {8'd3, 8'h6c, 8'd24, 8'h0a, 8'h00};
        75  : REG_DATA  =   {8'd3, 8'h6c, 8'd25, 8'hf3, 8'h00};
        76  : REG_DATA  =   {8'd3, 8'h6c, 8'd26, 8'h30, 8'h00};
        77  : REG_DATA  =   {8'd3, 8'h6c, 8'd27, 8'ha7, 8'h00};
        78  : REG_DATA  =   {8'd3, 8'h6c, 8'd28, 8'h54, 8'h00};
        79  : REG_DATA  =   {8'd3, 8'h6c, 8'd29, 8'h42, 8'h00};
        80  : REG_DATA  =   {8'd3, 8'h6c, 8'd30, 8'haa, 8'h00};
        81  : REG_DATA  =   {8'd3, 8'h6c, 8'd31, 8'h26, 8'h00};
        82  : REG_DATA  =   {8'd3, 8'h6c, 8'd32, 8'h0f, 8'h00};
        ...
        89  : REG_DATA  =   {8'd3, 8'h6c, 8'd39, 8'h00, 8'h00};
        ...
        104 : REG_DATA  =   {8'd3, 8'h6c, 8'd54, 8'h02, 8'h00};
        105 : REG_DATA  =   {8'd3, 8'h6c, 8'd55, 8'h3a, 8'h00};
        106 : REG_DATA  =   {8'd3, 8'h6c, 8'd56, 8'h80, 8'h00};
        107 : REG_DATA  =   {8'd3, 8'h6c, 8'd57, 8'h18, 8'h00};
        108 : REG_DATA  =   {8'd3, 8'h6c, 8'd58, 8'h71, 8'h00};
        109 : REG_DATA  =   {8'd3, 8'h6c, 8'd59, 8'h38, 8'h00};
        110 : REG_DATA  =   {8'd3, 8'h6c, 8'd60, 8'h2d, 8'h00};
        111 : REG_DATA  =   {8'd3, 8'h6c, 8'd61, 8'h40, 8'h00};
        112 : REG_DATA  =   {8'd3, 8'h6c, 8'd62, 8'h58, 8'h00};
        113 : REG_DATA  =   {8'd3, 8'h6c, 8'd63, 8'h2c, 8'h00};
        114 : REG_DATA  =   {8'd3, 8'h6c, 8'd64, 8'h45, 8'h00};
        115 : REG_DATA  =   {8'd3, 8'h6c, 8'd65, 8'h00, 8'h00};
        116 : REG_DATA  =   {8'd3, 8'h6c, 8'd66, 8'h80, 8'h00};
        117 : REG_DATA  =   {8'd3, 8'h6c, 8'd67, 8'h88, 8'h00};
        118 : REG_DATA  =   {8'd3, 8'h6c, 8'd68, 8'h42, 8'h00};
        ...
        127 : REG_DATA  =   {8'd3, 8'h6c, 8'd77, 8'h45, 8'h00};
        128 : REG_DATA  =   {8'd3, 8'h6c, 8'd78, 8'h53, 8'h00};
        129 : REG_DATA  =   {8'd3, 8'h6c, 8'd79, 8'h31, 8'h00};
        130 : REG_DATA  =   {8'd3, 8'h6c, 8'd80, 8'h30, 8'h00};
        131 : REG_DATA  =   {8'd3, 8'h6c, 8'd81, 8'h38, 8'h00};
        132 : REG_DATA  =   {8'd3, 8'h6c, 8'd82, 8'h46, 8'h00};
        133 : REG_DATA  =   {8'd3, 8'h6c, 8'd83, 8'h43, 8'h00};
        134 : REG_DATA  =   {8'd3, 8'h6c, 8'd84, 8'h31, 8'h00};
        135 : REG_DATA  =   {8'd3, 8'h6c, 8'd85, 8'h0a, 8'h00};
        ...
        176 : REG_DATA  =   {8'd3, 8'h6c, 8'd126,8'h01, 8'h00};
        177 : REG_DATA  =   {8'd3, 8'h6c, 8'd127,8'h91, 8'h00};
        // EDID END
