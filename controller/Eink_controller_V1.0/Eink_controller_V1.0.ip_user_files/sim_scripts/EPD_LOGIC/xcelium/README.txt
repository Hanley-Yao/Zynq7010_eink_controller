...
#
# Generated by export_simulation on Sun Oct 02 12:01:40 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './EPD_LOGIC.sh' script.

./EPD_LOGIC.sh -reset_run
...
./EPD_LOGIC.sh -noclean_files

For more information on the script, please type './EPD_LOGIC.sh -help'.
