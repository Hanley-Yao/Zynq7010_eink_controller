...
proc ps7_ddr_init_data_3_0 {} {
    ...
    mask_write 0XF80060F4 0x0000000F 0x00000004
...
proc ps7_ddr_ecc_init {} {
        ...
        while { $LengthBytes > 0} {
                ...
                #// CR - 880958
                #// Set up PCAP DMA at Full Rate Here 
                mask_write 0XF8007000 0x02000000 0x00000000                
                ...
                # */
                #//ClearPcap_Status();
                mask_write 0XF800700C 0xFFFFFFFF 0xFFFFFFFF 
        ...
        mask_write $PS7_DDR_CHE_ECC_CONTROL_REG_OFFSET 0x00000003 $PS7_RELEASE_ERROR_ECC

        #// CR - 880958
        #// Set up PCAP DMA back at quarter Rate Here 
