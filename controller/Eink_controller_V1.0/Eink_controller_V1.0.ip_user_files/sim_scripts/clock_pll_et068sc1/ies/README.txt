...
#
# Generated by export_simulation on Sun Oct 09 16:31:49 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './clock_pll_et068sc1.sh' script.

./clock_pll_et068sc1.sh -reset_run
...
./clock_pll_et068sc1.sh -noclean_files

For more information on the script, please type './clock_pll_et068sc1.sh -help'.
