...
#
# Generated by export_simulation on Sun Oct 02 11:57:48 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './blk_mem_gen_gray.sh' script.

./blk_mem_gen_gray.sh -reset_run
...
./blk_mem_gen_gray.sh -noclean_files

For more information on the script, please type './blk_mem_gen_gray.sh -help'.
