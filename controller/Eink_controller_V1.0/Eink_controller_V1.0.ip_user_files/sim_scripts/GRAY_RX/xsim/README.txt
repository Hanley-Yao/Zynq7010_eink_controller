...
#
# Generated by export_simulation on Sun Oct 02 12:02:22 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './GRAY_RX.sh' script.

./GRAY_RX.sh -reset_run
...
./GRAY_RX.sh -noclean_files

For more information on the script, please type './GRAY_RX.sh -help'.
